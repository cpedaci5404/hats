...
def get_args():
    ...
    argp.add_argument('--data_type', type=str, choices=['S5CONS', 'S5ENRS', 'S5UTIL', 'S5FINL', 'S5INFT'], required=False, default = 'S5CONS')
    ...
    argp.add_argument('--feature_list', nargs='+', type=str, help='return, volume, close', default= ['return'])
    ...
    argp.add_argument('--label_proportion', nargs='+', type=int, required=False, default = [1, 1, 1])
